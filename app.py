...
def cargar_datos():
    ...
    # Mapeo exacto basado en la estructura de tu imagen de Excel
...
# 1. Filtro dinámico por Región (Centro, Norte, Sur, etc.)
...
# Filtrar dataset para obtener los coordinadores de la región elegida
...
# METRICAS CALCULADAS DE FORMA ÚNICA POR AGENCIA
...
with col_izq:
    ...
    # Agrupación por agencia única para evitar multiplicidad de transacciones por terminal
    ...
    # Tabla interactiva con filtro por clic funcional
