...
# Estilos CSS con colores independientes para cada botón KPI
st.markdown("""
    <style>
    .stApp {
    ...
    /* Reglas para dar formato de Tarjetas Ejecutivas a los Botones de la fila de KPIs */
...
# BOTONES KPI CON NUEVO ESTILO DE COLOR Y TEXTO CLARO
...
# TABLA DETALLADA SEGÚN EL BOTÓN CLIQUEADO
