...
USUARIOS_AUTORIZADOS = {
    ...
    "juan.perez": {"clave": "juan2026", "rol": "Coordinador", "nombre": "Juan Pérez"},
    "maria.lopez": {"clave": "maria2026", "rol": "Supervisora", "nombre": "María López"},
    "gerencia": {"clave": "gerencia2026", "rol": "Lectura", "nombre": "Gerencia General"}
}
...
def registrar_ingreso(usuario, rol):
    ...
    nuevo_log = pd.DataFrame([{"Usuario": usuario, "Rol": rol, "FechaHora": fecha_hora}])
...
with tab_dash:
    if df_base.empty:
        st.warning("⚠️ No se ha encontrado ninguna matriz cargada. Por favor, ve a la pestaña '⚙️ Módulo Administrador' para subir el primer archivo Excel.")
    else:
...
# =============================================================================
# PESTAÑA 2: MÓDULO ADMINISTRADOR Y REGISTRO DE AUDITORÍA
# =============================================================================
with tab_admin:
    ...
    if st.session_state.get('rol_actual') != "Administrador":
        st.warning("🔒 Esta sección está reservada únicamente para el Administrador del sistema.")
    else:
