...
with tab_dash:
    if df_base.empty:
        ...
        # 3. FILTRO POR DÍA O RANGO DE FECHAS (CONSULTA DIARIA DE HISTÓRICO)
        st.sidebar.markdown("---")
        st.sidebar.subheader("📅 Consulta por Día / Rango")
        ...
        # Filtrado por fecha seleccionada en el calendario
        if rango_fechas:
        ...
        # Botón para descargar el reporte de la fecha/filtros seleccionados
        ...
        # TARJETAS DE INDICADORES CLAVE CON ACCIÓN DE CLIC RERUN
