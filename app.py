...
with tab_dash:
    if df_base.empty:
        ...
        # TARJETAS DE INDICADORES + BOTONES CON CALLBACK ON_CLICK
        ...
        # TABLA DE DETALLE QUE RESPONDE DE INMEDIATO AL DAR CLIC EN CUALQUIER BOTÓN
        ...
        # BLOQUE: RESUMEN EJECUTIVO POR COORDINADOR
        ...
        # BLOQUE: DASHBOARD TRANSACCIONAL
        st.markdown("<br>", unsafe_allow_html=True)
...
with tab_admin:
    ...
    st.write("Suba la matriz correspondiente a la fecha actual. Cada archivo cargado quedará etiquetado permanentemente con su fecha de carga para ser consultado cuando lo necesite.")
    ...
    if clave == "admin123":
        ...
        with col_up2:
            ...
            st.metric("Matrices por Fecha Almacenadas", f"{df_base['FechaCargaMatriz'].nunique() if 'FechaCargaMatriz' in df_base.columns else 1}")
