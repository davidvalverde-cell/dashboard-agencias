...
def cargar_datos():
    ...
    if not df.empty:
        ...
        # Garantizar columna de fecha de carga
...
# -----------------------------------------------------------------------------
# GENERACIÓN DE INFORME RESUMEN EN WORD (.DOCX)
# -----------------------------------------------------------------------------
...
with tab_dash:
    if df_base.empty:
        ...
        # SELECTOR HISTÓRICO DE MATRICES POR FECHA DE SUBIDA
        ...
        # BLOQUE 3: DASHBOARD TRANSACCIONAL
        st.markdown("<br>", unsafe_allow_html=True)
